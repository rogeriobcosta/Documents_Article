library(readxl)
Esp1_EspNow_50m_5s_CB <- read_excel("Esp1 EspNow 50m 5s CB.xlsx")
Esp2_EspNow_50m_5s_CB <- read_excel("Esp2 EspNow 50m 5s CB.xlsx")
Esp3_EspNow_50m_5s_CB <- read_excel("Esp3 EspNow 50m 5s CB.xlsx")
Esp4_EspNow_50m_5s_CB <- read_excel("Esp4 EspNow 50m 5s CB.xlsx")

View(Esp1_EspNow_50m_5s_CB)
View(Esp2_EspNow_50m_5s_CB)
View(Esp3_EspNow_50m_5s_CB)
View(Esp4_EspNow_50m_5s_CB)


require(lubridate)
Esp1_EspNow_50m_5s_CB$t<-hour(Esp1_EspNow_50m_5s_CB$Column1)
Esp1_EspNow_50m_5s_CB$status<-ifelse(Esp1_EspNow_50m_5s_CB$Column9<=2.8,1,0)

Esp2_EspNow_50m_5s_CB$t<-hour(Esp2_EspNow_50m_5s_CB$Column1)
Esp2_EspNow_50m_5s_CB$status<-ifelse(Esp2_EspNow_50m_5s_CB$Column9<=2.8,1,0)

Esp3_EspNow_50m_5s_CB$t<-hour(Esp3_EspNow_50m_5s_CB$Column1)
Esp3_EspNow_50m_5s_CB$status<-ifelse(Esp3_EspNow_50m_5s_CB$Column9<=2.8,1,0)

Esp4_EspNow_50m_5s_CB$t<-hour(Esp4_EspNow_50m_5s_CB$Column1)
Esp4_EspNow_50m_5s_CB$status<-ifelse(Esp4_EspNow_50m_5s_CB$Column9<=2.8,1,0)

dados1_50m_5s_CB<-Esp1_EspNow_50m_5s_CB[,9:10]
dados1_50m_5s_CB$Barreira="Esp1_EspNow_50m_5s_CB"
dados1_50m_5s_CB$t0=min(dados1_50m_5s_CB$t)
dados1_50m_5s_CB$survt<-dados1_50m_5s_CB$t-dados1_50m_5s_CB$t0

dados2_50m_5s_CB<-Esp2_EspNow_50m_5s_CB[,9:10]
dados2_50m_5s_CB$Barreira="Esp2_EspNow_50m_5s_CB"
dados2_50m_5s_CB$t0=min(dados2_50m_5s_CB$t)
dados2_50m_5s_CB$survt<-dados2_50m_5s_CB$t-dados2_50m_5s_CB$t0

dados3_50m_5s_CB<-Esp3_EspNow_50m_5s_CB[,9:10]
dados3_50m_5s_CB$Barreira="Esp3_EspNow_50m_5s_CB"
dados3_50m_5s_CB$t0=min(dados3_50m_5s_CB$t)
dados3_50m_5s_CB$survt<-dados3_50m_5s_CB$t-dados3_50m_5s_CB$t0

dados4_50m_5s_CB<-Esp4_EspNow_50m_5s_CB[,9:10]
dados4_50m_5s_CB$Barreira="Esp4_EspNow_50m_5s_CB"
...
ggsave("Grafico_KM_ESP_EspNow_50m_5s_CB.png")
