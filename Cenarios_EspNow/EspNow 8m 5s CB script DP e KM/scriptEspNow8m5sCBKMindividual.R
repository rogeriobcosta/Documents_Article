...
Esp1_EspNow_8m_5s_CB$status<-ifelse(Esp1_EspNow_8m_5s_CB$Column9<=2.8,1,0)

Esp2_EspNow_8m_5s_CB$t<-hour(Esp2_EspNow_8m_5s_CB$Column1)
Esp2_EspNow_8m_5s_CB$status<-ifelse(Esp2_EspNow_8m_5s_CB$Column9<=2.8,1,0)

Esp3_EspNow_8m_5s_CB$t<-hour(Esp3_EspNow_8m_5s_CB$Column1)
Esp3_EspNow_8m_5s_CB$status<-ifelse(Esp3_EspNow_8m_5s_CB$Column9<=2.8,1,0)

Esp4_EspNow_8m_5s_CB$t<-hour(Esp4_EspNow_8m_5s_CB$Column1)
Esp4_EspNow_8m_5s_CB$status<-ifelse(Esp4_EspNow_8m_5s_CB$Column9<=2.8,1,0)
