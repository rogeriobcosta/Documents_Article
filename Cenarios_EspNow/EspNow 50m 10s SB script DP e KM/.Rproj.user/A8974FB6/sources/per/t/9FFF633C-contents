library(readxl)
Esp1_EspNow_50m_10s_SB <- read_excel("Esp1 EspNow 50m 10s SB.xlsx")
Esp2_EspNow_50m_10s_SB <- read_excel("Esp2 EspNow 50m 10s SB.xlsx")
Esp3_EspNow_50m_10s_SB <- read_excel("Esp3 EspNow 50m 10s SB.xlsx")
Esp4_EspNow_50m_10s_SB <- read_excel("Esp4 EspNow 50m 10s SB.xlsx")

View(Esp1_EspNow_50m_10s_SB)
View(Esp2_EspNow_50m_10s_SB)
View(Esp3_EspNow_50m_10s_SB)
View(Esp4_EspNow_50m_10s_SB)


require(lubridate)
Esp1_EspNow_50m_10s_SB$t<-hour(Esp1_EspNow_50m_10s_SB$Column1)
Esp1_EspNow_50m_10s_SB$status<-ifelse(Esp1_EspNow_50m_10s_SB$Column9<=2.8,1,0)

Esp2_EspNow_50m_10s_SB$t<-hour(Esp2_EspNow_50m_10s_SB$Column1)
Esp2_EspNow_50m_10s_SB$status<-ifelse(Esp2_EspNow_50m_10s_SB$Column9<=2.8,1,0)

Esp3_EspNow_50m_10s_SB$t<-hour(Esp3_EspNow_50m_10s_SB$Column1)
Esp3_EspNow_50m_10s_SB$status<-ifelse(Esp3_EspNow_50m_10s_SB$Column9<=2.8,1,0)

Esp4_EspNow_50m_10s_SB$t<-hour(Esp4_EspNow_50m_10s_SB$Column1)
Esp4_EspNow_50m_10s_SB$status<-ifelse(Esp4_EspNow_50m_10s_SB$Column9<=2.8,1,0)

dados1_50m_10s_SB<-Esp1_EspNow_50m_10s_SB[,9:10]
dados1_50m_10s_SB$Barreira="Esp1_EspNow_50m_10s_SB"
dados1_50m_10s_SB$t0=min(dados1_50m_10s_SB$t)
dados1_50m_10s_SB$survt<-dados1_50m_10s_SB$t-dados1_50m_10s_SB$t0

dados2_50m_10s_SB<-Esp2_EspNow_50m_10s_SB[,9:10]
dados2_50m_10s_SB$Barreira="Esp2_EspNow_50m_10s_SB"
dados2_50m_10s_SB$t0=min(dados2_50m_10s_SB$t)
dados2_50m_10s_SB$survt<-dados2_50m_10s_SB$t-dados2_50m_10s_SB$t0

dados3_50m_10s_SB<-Esp3_EspNow_50m_10s_SB[,9:10]
dados3_50m_10s_SB$Barreira="Esp3_EspNow_50m_10s_SB"
dados3_50m_10s_SB$t0=min(dados3_50m_10s_SB$t)
dados3_50m_10s_SB$survt<-dados3_50m_10s_SB$t-dados3_50m_10s_SB$t0

dados4_50m_10s_SB<-Esp4_EspNow_50m_10s_SB[,9:10]
dados4_50m_10s_SB$Barreira="Esp4_EspNow_50m_10s_SB"
...
ggsave("Grafico_KM_ESP_EspNow_50m_10s_SB .png")
