...
valor<-plan_ESP1_EspNow_50m_10s_CB$Column9
...
plan_ESP1_EspNow_50m_10s_CB$nivel<-c(a,b,c)
...
write.csv(a,file="saida_dp_ESP1_EspNow_50m_10s_CB.csv")
...
labs(title = "ESP1_EspNow_50m_10s_CB", subtitle = "Gráfico Desvio Padrão")

ggsave("Grafico_DP_ESP1_EspNow_50m_10s_CB.png")
