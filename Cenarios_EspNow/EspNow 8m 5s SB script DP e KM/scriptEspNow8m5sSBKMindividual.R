library(readxl)
Esp1_EspNow_8m_5s_SB <- read_excel("Esp1 EspNow 8m 5s SB.xlsx")
Esp2_EspNow_8m_5s_SB <- read_excel("Esp2 EspNow 8m 5s SB.xlsx")
Esp3_EspNow_8m_5s_SB <- read_excel("Esp3 EspNow 8m 5s SB.xlsx")
Esp4_EspNow_8m_5s_SB <- read_excel("Esp4 EspNow 8m 5s SB.xlsx")

View(Esp1_EspNow_8m_5s_SB)
View(Esp2_EspNow_8m_5s_SB)
View(Esp3_EspNow_8m_5s_SB)
View(Esp4_EspNow_8m_5s_SB)


require(lubridate)
Esp1_EspNow_8m_5s_SB$t<-hour(Esp1_EspNow_8m_5s_SB$Column1)
Esp1_EspNow_8m_5s_SB$status<-ifelse(Esp1_EspNow_8m_5s_SB$Column9<=2.8,1,0)

Esp2_EspNow_8m_5s_SB$t<-hour(Esp2_EspNow_8m_5s_SB$Column1)
Esp2_EspNow_8m_5s_SB$status<-ifelse(Esp2_EspNow_8m_5s_SB$Column9<=2.8,1,0)

Esp3_EspNow_8m_5s_SB$t<-hour(Esp3_EspNow_8m_5s_SB$Column1)
Esp3_EspNow_8m_5s_SB$status<-ifelse(Esp3_EspNow_8m_5s_SB$Column9<=2.8,1,0)

Esp4_EspNow_8m_5s_SB$t<-hour(Esp4_EspNow_8m_5s_SB$Column1)
Esp4_EspNow_8m_5s_SB$status<-ifelse(Esp4_EspNow_8m_5s_SB$Column9<=2.8,1,0)

dados1_8m_5s_SB<-Esp1_EspNow_8m_5s_SB[,9:10]
dados1_8m_5s_SB$Barreira="Esp1_EspNow_8m_5s_SB"
dados1_8m_5s_SB$t0=min(dados1_8m_5s_SB$t)
dados1_8m_5s_SB$survt<-dados1_8m_5s_SB$t-dados1_8m_5s_SB$t0

dados2_8m_5s_SB<-Esp2_EspNow_8m_5s_SB[,9:10]
dados2_8m_5s_SB$Barreira="Esp2_EspNow_8m_5s_SB"
dados2_8m_5s_SB$t0=min(dados2_8m_5s_SB$t)
dados2_8m_5s_SB$survt<-dados2_8m_5s_SB$t-dados2_8m_5s_SB$t0

dados3_8m_5s_SB<-Esp3_EspNow_8m_5s_SB[,9:10]
dados3_8m_5s_SB$Barreira="Esp3_EspNow_8m_5s_SB"
dados3_8m_5s_SB$t0=min(dados3_8m_5s_SB$t)
dados3_8m_5s_SB$survt<-dados3_8m_5s_SB$t-dados3_8m_5s_SB$t0

dados4_8m_5s_SB<-Esp4_EspNow_8m_5s_SB[,9:10]
dados4_8m_5s_SB$Barreira="Esp4_EspNow_8m_5s_SB"
...
ggsave("Grafico_KM_ESP_EspNow_8m_5s_SB.png")
