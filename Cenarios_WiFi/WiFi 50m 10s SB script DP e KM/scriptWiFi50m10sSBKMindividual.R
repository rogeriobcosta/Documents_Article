...
Esp1_WiFi_50m_10s_SB$status<-ifelse(Esp1_WiFi_50m_10s_SB$Column9<=2.8,1,0)

Esp2_WiFi_50m_10s_SB$t<-hour(Esp2_WiFi_50m_10s_SB$Column1)
Esp2_WiFi_50m_10s_SB$status<-ifelse(Esp2_WiFi_50m_10s_SB$Column9<=2.8,1,0)

Esp3_WiFi_50m_10s_SB$t<-hour(Esp3_WiFi_50m_10s_SB$Column1)
Esp3_WiFi_50m_10s_SB$status<-ifelse(Esp3_WiFi_50m_10s_SB$Column9<=2.8,1,0)

Esp4_WiFi_50m_10s_SB$t<-hour(Esp4_WiFi_50m_10s_SB$Column1)
Esp4_WiFi_50m_10s_SB$status<-ifelse(Esp4_WiFi_50m_10s_SB$Column9<=2.8,1,0)
