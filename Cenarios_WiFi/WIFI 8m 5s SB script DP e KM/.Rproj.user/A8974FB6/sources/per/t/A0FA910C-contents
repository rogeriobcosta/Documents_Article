library(readxl)
Esp1_WiFi_8m_5s_SB <- read_excel("ESP1 WiFi 8m 5s SB.xlsx")
Esp2_WiFi_8m_5s_SB <- read_excel("ESP2 WiFi 8m 5s SB.xlsx")
Esp3_WiFi_8m_5s_SB <- read_excel("ESP3 WiFi 8m 5s SB.xlsx")
Esp4_WiFi_8m_5s_SB <- read_excel("ESP4 WiFi 8m 5s SB.xlsx")

View(Esp1_WiFi_8m_5s_SB)
View(Esp2_WiFi_8m_5s_SB)
View(Esp3_WiFi_8m_5s_SB)
View(Esp4_WiFi_8m_5s_SB)


require(lubridate)
Esp1_WiFi_8m_5s_SB$t<-hour(Esp1_WiFi_8m_5s_SB$Column1)
Esp1_WiFi_8m_5s_SB$status<-ifelse(Esp1_WiFi_8m_5s_SB$Column9<=2.8,1,0)

Esp2_WiFi_8m_5s_SB$t<-hour(Esp2_WiFi_8m_5s_SB$Column1)
Esp2_WiFi_8m_5s_SB$status<-ifelse(Esp2_WiFi_8m_5s_SB$Column9<=2.8,1,0)

Esp3_WiFi_8m_5s_SB$t<-hour(Esp3_WiFi_8m_5s_SB$Column1)
Esp3_WiFi_8m_5s_SB$status<-ifelse(Esp3_WiFi_8m_5s_SB$Column9<=2.8,1,0)

Esp4_WiFi_8m_5s_SB$t<-hour(Esp4_WiFi_8m_5s_SB$Column1)
Esp4_WiFi_8m_5s_SB$status<-ifelse(Esp4_WiFi_8m_5s_SB$Column9<=2.8,1,0)

dados1_8m_5s_SB<-Esp1_WiFi_8m_5s_SB[,9:10]
dados1_8m_5s_SB$Barreira="Esp1_WiFi_8m_5s_SB"
dados1_8m_5s_SB$t0=min(dados1_8m_5s_SB$t)
dados1_8m_5s_SB$survt<-dados1_8m_5s_SB$t-dados1_8m_5s_SB$t0

dados2_8m_5s_SB<-Esp2_WiFi_8m_5s_SB[,9:10]
dados2_8m_5s_SB$Barreira="Esp2_WiFi_8m_5s_SB"
dados2_8m_5s_SB$t0=min(dados2_8m_5s_SB$t)
dados2_8m_5s_SB$survt<-dados2_8m_5s_SB$t-dados2_8m_5s_SB$t0

dados3_8m_5s_SB<-Esp3_WiFi_8m_5s_SB[,9:10]
dados3_8m_5s_SB$Barreira="Esp3_WiFi_8m_5s_SB"
dados3_8m_5s_SB$t0=min(dados3_8m_5s_SB$t)
dados3_8m_5s_SB$survt<-dados3_8m_5s_SB$t-dados3_8m_5s_SB$t0

dados4_8m_5s_SB<-Esp4_WiFi_8m_5s_SB[,9:10]
dados4_8m_5s_SB$Barreira="Esp4_WiFi_8m_5s_SB"
...
ggsave("Grafico_KM_ESP_WiFi_8m_5s_SB.png")
