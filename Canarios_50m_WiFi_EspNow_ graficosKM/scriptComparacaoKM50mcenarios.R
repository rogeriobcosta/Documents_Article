...
dadosEspNow_50m_5s_CB$Grupo="EspNow_50m_5s_CB"
...
dadosEspNow_50m_5s_SB$Grupo="EspNow_50m_5s_SB"
...
dadosEspNow_50m_10s_CB$Grupo="EspNow_50m_10s_CB"
...
dadosEspNow_50m_10s_SB$Grupo="EspNow_50m_10s_SB"
...
dadosWiFi_50m_5s_CB$Grupo="WiFi_50m_5s_CB"
...
dadosWiFi_50m_5s_SB$Grupo="WiFi_50m_5s_SB"
...
dadosWiFi_50m_10s_CB$Grupo="WiFi_50m_10s_CB"
...
dadosWiFi_50m_10s_SB$Grupo="WiFi_50m_10s_SB"
...
dados_50m_5m_5s_10s$Grupo <- as.factor(dados_50m_5m_5s_10s$Grupo)
...
kmfit = survfit(Y ~ dados_50m_5m_5s_10s$Grupo)

summary(kmfit, times = c(seq(0, 23, by = 1)))
saida<-summary(kmfit, times = c(seq(0, 23, by = 1)))
...
plot(kmfit, lty = c("solid", "dashed", "dotted", "solid", "solid", "dashed", "dotted", "solid"), col = c("black", "grey", "blue", "red", "green", "yellow", "purple", "orange"), xlab = "Survival Time In Days", ylab = "Survival Probabilities")
legend("topright", c("EspNow_50m_5s_CB", "EspNow_50m_5s_SB","EspNow_50m_10s_CB", "EspNow_50m_10s_SB", "WiFi_50m_5s_CB", "WiFi_50m_5s_SB","WiFi_50m_10s_CB", "WiFi_50m_10s_SB" ), lty = c("solid", "dashed", "dotted", "solid", "solid", "dashed", "dotted", "solid"), col = c("black", "grey", "blue", "red", "green", "yellow", "purple", "orange"))

#Metodo Log-rank
survdiff(formula = Surv(survt, status) ~ Grupo, data = dados_50m_5m_5s_10s,  rho = 0)

#Metodo Peto
survdiff(formula = Surv(survt, status) ~ Grupo, data = dados_50m_5m_5s_10s,  rho = 1)

library(ggplot2)
library(ggfortify)

model_fit <- survfit(Surv(survt, status) ~ Grupo, data = dados_50m_5m_5s_10s)

autoplot(model_fit) + 
  labs(x = "\n Tempo de Sobrevivência ", y = "Probabilidade de Sobrevivência \n", 
       title = "Tempo de Sobrevivência\n Cenarios EspNow e WiFi de 50m \n") + 
...
ggsave("Grafico_KM_Cenarios EspNow e WiFi de 50m.png")
