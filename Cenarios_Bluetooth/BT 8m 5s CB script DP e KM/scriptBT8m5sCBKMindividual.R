library(readxl)
Esp1_BT_8m_5s_CB <- read_excel("Esp1 BT 8m 5s CB.xlsx")
Esp2_BT_8m_5s_CB <- read_excel("Esp2 BT 8m 5s CB.xlsx")
Esp3_BT_8m_5s_CB <- read_excel("Esp3 BT 8m 5s CB.xlsx")
Esp4_BT_8m_5s_CB <- read_excel("Esp4 BT 8m 5s CB.xlsx")

View(Esp1_BT_8m_5s_CB)
View(Esp2_BT_8m_5s_CB)
View(Esp3_BT_8m_5s_CB)
View(Esp4_BT_8m_5s_CB)


require(lubridate)
Esp1_BT_8m_5s_CB$t<-hour(Esp1_BT_8m_5s_CB$Column1)
Esp1_BT_8m_5s_CB$status<-ifelse(Esp1_BT_8m_5s_CB$Column9<=2.8,1,0)

Esp2_BT_8m_5s_CB$t<-hour(Esp2_BT_8m_5s_CB$Column1)
Esp2_BT_8m_5s_CB$status<-ifelse(Esp2_BT_8m_5s_CB$Column9<=2.8,1,0)

Esp3_BT_8m_5s_CB$t<-hour(Esp3_BT_8m_5s_CB$Column1)
Esp3_BT_8m_5s_CB$status<-ifelse(Esp3_BT_8m_5s_CB$Column9<=2.8,1,0)

Esp4_BT_8m_5s_CB$t<-hour(Esp4_BT_8m_5s_CB$Column1)
Esp4_BT_8m_5s_CB$status<-ifelse(Esp4_BT_8m_5s_CB$Column9<=2.8,1,0)

dados1_8m_5s_CB<-Esp1_BT_8m_5s_CB[,9:10]
dados1_8m_5s_CB$Barreira="Esp1_BT_8m_5s_CB"
dados1_8m_5s_CB$t0=min(dados1_8m_5s_CB$t)
dados1_8m_5s_CB$survt<-dados1_8m_5s_CB$t-dados1_8m_5s_CB$t0

dados2_8m_5s_CB<-Esp2_BT_8m_5s_CB[,9:10]
dados2_8m_5s_CB$Barreira="Esp2_BT_8m_5s_CB"
dados2_8m_5s_CB$t0=min(dados2_8m_5s_CB$t)
dados2_8m_5s_CB$survt<-dados2_8m_5s_CB$t-dados2_8m_5s_CB$t0

dados3_8m_5s_CB<-Esp3_BT_8m_5s_CB[,9:10]
dados3_8m_5s_CB$Barreira="Esp3_BT_8m_5s_CB"
dados3_8m_5s_CB$t0=min(dados3_8m_5s_CB$t)
dados3_8m_5s_CB$survt<-dados3_8m_5s_CB$t-dados3_8m_5s_CB$t0

dados4_8m_5s_CB<-Esp4_BT_8m_5s_CB[,9:10]
dados4_8m_5s_CB$Barreira="Esp4_BT_8m_5s_CB"
...
ggsave("Grafico_KM_ESP_BT_8m_5s_CB.png")
